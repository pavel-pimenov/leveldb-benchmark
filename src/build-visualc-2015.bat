...
@del leveldb-create-test-db-cpp.exe
@del *.obj
...
cl /MT /I ".\leveldb" /I ".\leveldb\include" /I ".\leveldb\util" /I ".\leveldb\table" /I ".\leveldb\db" /I ".\leveldb\port\win" /I ".\snappy" /D USE_LEVEL_DB_FILL_TEST /D "ssize_t=ptrdiff_t" /D _CONSOLE /D HAVE_SNAPPY /D LEVELDB_PLATFORM_WINDOWS /D WINVER=0x0501 /D WIN32_LEAN_AND_MEAN /D NOMINMAX /D _CRT_SECURE_NO_WARNINGS /D _CRT_NONSTDC_NO_WARNINGS /W3 /Oi /EHsc leveldb-clone-cpp.cpp @leveldb-files -Feleveldb-create-test-db-cpp.exe
